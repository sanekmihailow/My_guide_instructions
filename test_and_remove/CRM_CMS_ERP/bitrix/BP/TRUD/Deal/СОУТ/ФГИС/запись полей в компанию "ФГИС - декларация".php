...
$declaration_deal = $USER_FIELD_MANAGER->GetUserFieldValue('CRM_DEAL', 'UF_CRM_1584020665',$deal_id);
...
$set_company_declaration = $USER_FIELD_MANAGER->Update('CRM_COMPANY', $company_id, array("UF_CRM_1584020665" => CFile::MakeFileArray($declaration_deal)));
